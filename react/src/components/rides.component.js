...
const Exercise = props => (
  ...
  <tr>
    {/* make tripid as link */}
    <Link to={`/admin/SuperAdmin/ride/${props.exercise.trip_id}`}>
        {props.exercise.trip_id}
      </Link>
...
export default class ExercisesList extends Component {
  ...
  componentDidMount() {
    // set cookie of admin_client_id which is the id after /
    localStorage.setItem('admin_client_id', this.props.match.params.id);
    axios
      .post('http://127.0.0.1:8000/staff/user_rides/', {
